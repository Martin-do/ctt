...
, function(t, e, n) {
    ...
    function Et(t) {
        ...
        u.default)(t, ["store", "computedStyle"]), c = o.element, s = o.actionItem, f = o.immediate, l = o.pluginInstance, d = o.continuous, p = o.restingValue, v = o.eventId, h = !d, m = P(), _ = r.getState(), b = _.ixElements, w = _.ixSession, I = _.ixData, T = C(b, c), O = (b[T] || {}).refState, A = y.getRefType(c), x = w.reducedMotion && g.ReducedMotionTypes[s.actionTypeId];
        if (x && d)
...
, function(t, e, n) {
    ...
    r.define("ix", t.exports = function(t, e) {
        var n, o, a = {}, u = t(window), c = ".w-ix", s = t.tram, f = r.env, l = f(), d = f.chrome && f.chrome < 35, p = "none 0s ease 0s", v = t(), h = {}, g = [], m = [], E = [], y = 1, _ = {
...
, function(t, e, n) {
    var r, i, o, a = n(160), u = n(0), c = n(5), s = n(20), f = n(44), l = n(9), d = n(42), p = n(84), v = n(45), h = u.TypeError, g = u.WeakMap;
    if (a || d.state) {
...
, function(t, e, n) {
    var r, i = n(30), o = n(172), a = n(46), u = n(45), c = n(174), s = n(82), f = n(84), l = f("IE_PROTO"), d = function() {}, p = function(t) {
...
, function(t, e, n) {
    ...
    e.getInstanceOrigin = function(t) {
        ...
        case it:
            return wt(e[r.actionTypeId], r.config.filters);
        case ot:
            return It(e[r.actionTypeId], r.config.fontVariations);
        case rt:
            return {
                value: (0,
        ...
        case at:
            ...
            return a = r.config.widthUnit === B ? bt.test(c) ? parseFloat(c) : parseFloat(n.width) : (0,
            f.default)(parseFloat(c), parseFloat(n.width)),
            u = r.config.heightUnit === B ? bt.test(s) ? parseFloat(s) : parseFloat(n.height) : (0,
    ...
    e.getDestinationValues = function(t) {
        var e = t.element
          ...
          , r = t.elementApi;
        if ((0,
        m.isPluginType)(n.actionTypeId))
            return (0,
            m.getPluginDestination)(n.actionTypeId)(n.config);
        switch (n.actionTypeId) {
        case J:
        case tt:
        case et:
    ...
    e.renderHTMLElement = function(t, e, n, r, i, o, a, u, c) {
        ...
        case K:
            return function(t, e, n, r, i) {
                ...
                l = c.yValue,
                d = c.zValue,
                (s === J && void 0 !== d || s === tt && void 0 !== d || s === et && (void 0 !== f || void 0 !== l)) && a(t, E.TRANSFORM_STYLE_PREFIXED, S);
                var u, c, s, f, l, d
            }(t, e, n, i, a);
        case q:
            return function(t, e, n, r, i, o) {
                ...
                case st:
                    var h = pt[r.actionTypeId]
                      ...
                      , y = n.aValue;
                    Pt(t, h, o),
                    a(t, h, y >= 1 ? "rgb(".concat(g, ",").concat(m, ",").concat(E, ")") : "rgba(".concat(g, ",").concat(m, ",").concat(E, ",").concat(y, ")"));
                    break;
                default:
                    var _ = r.config.unit
                      , b = void 0 === _ ? "" : _;
    ...
    function _t(t) {
        ...
        var R, N, C, L = (null !== (e = null == o ? void 0 : null === (n = o.action) || void 0 === n ? void 0 : null === (r = n.config) || void 0 === r ? void 0 : r.affectedElements) && void 0 !== e ? e : {})[w || T] || {}, D = Boolean(L.id || L.selector), P = o && l(yt(o.target));
        ...
        return null == N || null == C ? [] : E.IS_BROWSER_ENV && u ? d(C).filter(function(t) {
            return u.contains(t)
        }) : R === F ? d(N, C) : R === X ? p(d(N)).filter(g(C)) : R === G ? h(d(N)).filter(g(C)) : d(C)
    }
    var bt = /px/
      , wt = function(t, e) {
        ...
        handler: function(t) {
            ...
            case h.EventBasedOn.PAGE:
                var S = ut()
                  ...
                  , C = S.scrollWidth
                  , L = S.scrollHeight;
                O = I ? Math.min(R + _, C) / C : Math.min(N + w, L) / L;
                break;
...
, function(t, e, n) {
    ...
    function f(t, e, n, r) {
        ...
        E.build = function() {
            ...
            f.spinner = F("spinner").attr("role", "progressbar").attr("aria-live", "polite").attr("aria-hidden", !1).attr("aria-busy", !0).attr("aria-valuemin", 0).attr("aria-valuemax", 100).attr("aria-valuenow", 0).attr("aria-valuetext", "Loading image"),
            ...
            f.content.on("swipe", T).on("click", D("left"), _).on("click", D("right"), b).on("click", D("close"), w).on("click", D("image, caption"), b),
...
, function(t, e, n) {
    ...
    r.define("tabs", t.exports = function(t) {
        var e, n, o = {}, a = t.tram, u = t(document), c = r.env, s = c.safari, f = c(), l = "data-w-tab", d = "data-w-pane", p = ".w-tabs", v = "w--current", h = "w--tab-active", g = i.triggers, m = !1;
        function E() {
            n = f && r.env("design"),
...
, function(t, e, n) {
    ...
    r.define("maps", t.exports = function(t, e) {
        var n, i = {}, o = t(document), a = null, u = ".w-widget-map", c = "AIzaSyCHsAKn-J43xxKjuaFu90Bp7hyJtSZntks";
        function s() {
            r.resize.off(l),
            r.redraw.off(l)
        }
...
Webflow.require('ix').init([{
    "slug": "teaser-rollover",
    "name": "Teaser-Rollover",
    "value": {
        "style": {},
        "triggers": [{
            "type": "hover",
            "selector": ".teaser-more",
            "descend": true,
            "preserve3d": true,
            "stepsA": [{
    ...
    "slug": "project-detail-image-caption",
    "name": "Project-Detail-Image-Caption",
    "value": {
        "style": {},
        "triggers": [{
            "type": "hover",
            "selector": ".project-detail-image-caption",
            "descend": true,
            "preserve3d": true,
            "stepsA": [{
                "opacity": 1,
    ...
    "slug": "project-detail-image-fade-in",
    "name": "Project-Detail-Image-Fade-In",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
    ...
    "slug": "hero-fade-in-onload-topdown",
    "name": "Hero-Fade-In-OnLoad-TopDown",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "display": "block",
                "opacity": 1,
                "transition": "transform 300ms ease 0ms, opacity 200ms ease 0ms",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "slug": "blog-widget-rollover",
    "name": "Blog-Widget-Rollover",
    "value": {
        "style": {},
        "triggers": [{
            "type": "hover",
            "selector": ".blog-widget-rollover",
            "descend": true,
            "preserve3d": true,
            "stepsA": [{
    ...
    "slug": "blog-line-rollover",
    "name": "Blog-Line-Rollover",
    "value": {
        "style": {},
        "triggers": [{
            "type": "hover",
            "selector": ".blog-rollover",
            "descend": true,
            "preserve3d": true,
            "stepsA": [{
                "transition": "transform 200ms ease 0ms",
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "width": "100%",
                "transition": "width 4000ms ease 0"
            }, {
                "width": "0px"
            }],
            "stepsB": []
    ...
    "slug": "breadcrumb-scroll-animation",
    "name": "Breadcrumb-Scroll-Animation",
    "value": {
        "style": {},
        "triggers": [{
            "type": "scroll",
    ...
    "slug": "breadcrumb-slide-in-on-load",
    "name": "Breadcrumb-Slide-in-on-Load",
    "value": {
        "style": {},
        "triggers": [{
            "type": "load",
    ...
    "slug": "license-pexels-close",
    "name": "license-pexels-close",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
            ...
            "stepsA": [{
                ...
                "y": "-50%",
                "z": "0px",
                "scaleX": 0.7500000000000002,
                "scaleY": 0.7500000000000002,
                "scaleZ": 1
            }],
            "stepsB": []
        }, {
    ...
    "slug": "license-unsplash",
    "name": "license-unsplash",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
            "selector": ".modal-dialog-unsplash",
            "stepsA": [{
                "display": "block",
                "opacity": 1
            }],
    ...
    "slug": "license-unsplash-close",
    "name": "license-unsplash-close",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
    ...
    "slug": "license-creative-commons",
    "name": "license-creative-commons",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
            "selector": ".modal-dialog-creative-commons",
            "stepsA": [{
                "display": "block",
                "opacity": 1
            }],
    ...
    "slug": "license-creative-commons-close",
    "name": "license-creative-commons-close",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
    ...
    "slug": "nav-hiding-initial",
    "name": "Nav Hiding Initial",
    "value": {
        "style": {
            "x": "0px",
            "y": "-100%",
    ...
    "slug": "nav-hiding-reveal",
    "name": "Nav Hiding Reveal",
    "value": {
        "style": {},
        "triggers": [{
            "type": "scroll",
